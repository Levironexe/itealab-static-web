...
export const BentoGridItem = ({
  ...
  return (
    <div
      className={cn(
        "group group/bento shadow-input row-span-1 flex flex-col justify-between border border-neutral-200 bg-background-light/50 backdrop-blur-3xl p-4 transition duration-200 relative",
        className,
      )}
    >
