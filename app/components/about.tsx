...
export function About() {
  ...
  return (
    <div id="about" className="relative w-full overflow-clip bg-background">
      <div className="max-w-7xl mx-auto pb-20 pt-24 px-4 md:px-8 lg:px-10 flex justify-start items-start gap-12">
        <div className="flex-[2] relative border-1 border-white/10">
          <Icon className="absolute h-6 w-6 -top-3 -left-3 dark:text-white text-black" />
      <Icon className="absolute h-6 w-6 -bottom-3 -left-3 dark:text-white text-black" />
      <Icon className="absolute h-6 w-6 -top-3 -right-3 dark:text-white text-black" />
      <Icon className="absolute h-6 w-6 -bottom-3 -right-3 dark:text-white text-black" />
          <h2   
           className="font-michroma text-lg md:text-4xl text-white pl-4 py-1 bg-gradient-to-r from-dark-green to-light-green max-w-4xl font-bold">
            About US
          </h2>
        ...
        <div className="flex-[3] relative border-1 border-white/10">
            <Icon className="absolute h-6 w-6 -top-3 -left-3 dark:text-white text-black" />
      <Icon className="absolute h-6 w-6 -bottom-3 -left-3 dark:text-white text-black" />
      <Icon className="absolute h-6 w-6 -top-3 -right-3 dark:text-white text-black" />
      <Icon className="absolute h-6 w-6 -bottom-3 -right-3 dark:text-white text-black" />
          <h2 className="font-michroma text-lg md:text-4xl text-white pl-4 py-1 bg-gradient-to-r from-dark-green to-light-green max-w-4xl font-bold">
            Our VISION
          </h2>
          <p className="text-neutral-700 dark:text-neutral-300 text-sm md:text-base p-4">
